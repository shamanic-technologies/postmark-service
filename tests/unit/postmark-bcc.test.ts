...
describe("postmark-client BCC behavior", () => {
  ...
  it("should always include kevin.lourd@gmail.com in BCC", async () => {
    await sendEmail({
    ...
    expect(mockSendEmail).toHaveBeenCalledWith(
      expect.objectContaining({
        Bcc: "kevin.lourd@gmail.com",
      })
    );
  });

  it("should append kevin.lourd@gmail.com to existing BCC", async () => {
    await sendEmail({
      from: "sender@test.com",
      to: "recipient@test.com",
      subject: "Test",
    ...
    expect(mockSendEmail).toHaveBeenCalledWith(
      expect.objectContaining({
        Bcc: "other@test.com,kevin.lourd@gmail.com",
      })
    );
  });
});
