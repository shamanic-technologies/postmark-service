...
describe("GET /internal/stats", () => {
  ...
  it("should support groupBy", async () => {
    ...
    await insertTestSending({ messageId: randomUUID(), toEmail: "a@test.com", brandId: brand, campaignId: "camp-a" });
    await insertTestSending({ messageId: randomUUID(), toEmail: "b@test.com", brandId: brand, campaignId: "camp-b" });
  ...
  it("should filter by featureSlugs (comma-separated plural)", async () => {
    ...
    await insertTestSending({ messageId: randomUUID(), toEmail: "a@test.com", brandId: brand, campaignId: "c1", featureSlug: "sales-cold-email-outreach" });
    await insertTestSending({ messageId: randomUUID(), toEmail: "b@test.com", brandId: brand, campaignId: "c1", featureSlug: "marketing-newsletter" });
    await insertTestSending({ messageId: randomUUID(), toEmail: "c@test.com", brandId: brand, campaignId: "c1", featureSlug: "other-feature" });
  ...
  it("should filter by workflowSlugs (comma-separated plural)", async () => {
    ...
    await insertTestSending({ messageId: randomUUID(), toEmail: "a@test.com", brandId: brand, campaignId: "c1", workflowSlug: "wf-alpha" });
    await insertTestSending({ messageId: randomUUID(), toEmail: "b@test.com", brandId: brand, campaignId: "c1", workflowSlug: "wf-beta" });
    await insertTestSending({ messageId: randomUUID(), toEmail: "c@test.com", brandId: brand, campaignId: "c1", workflowSlug: "wf-gamma" });
  ...
  it("should support groupBy workflowSlug with featureSlugs filter", async () => {
    ...
    await insertTestSending({ messageId: randomUUID(), toEmail: "a@test.com", brandId: brand, campaignId: "c1", featureSlug: "sales-cold-email-outreach", workflowSlug: "wf-1" });
    await insertTestSending({ messageId: randomUUID(), toEmail: "b@test.com", brandId: brand, campaignId: "c1", featureSlug: "sales-cold-email-outreach", workflowSlug: "wf-2" });
    await insertTestSending({ messageId: randomUUID(), toEmail: "c@test.com", brandId: brand, campaignId: "c1", featureSlug: "other-feature", workflowSlug: "wf-3" });
  ...
  it("should filter by single featureSlugs value (no comma)", async () => {
    await insertTestSending({ messageId: randomUUID(), toEmail: "a@test.com", brandId: "b-single", campaignId: "c1", featureSlug: "sales-cold-email-outreach" });
    await insertTestSending({ messageId: randomUUID(), toEmail: "b@test.com", brandId: "b-single", campaignId: "c1", featureSlug: "other" });
